...
<section class="vbox">
  <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
    <div class="navbar-header aside-md dk"> <a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen" data-target="#nav"> <i class="fa fa-bars"></i> </a> <a href="dashboard.php" class="navbar-brand"><img src="images/logo-dash.png" class="m-r-sm" style="max-height:50px;"></a> <a class="btn btn-link visible-xs" data-toggle="dropdown" data-target=".user"> <i class="fa fa-cog"></i> </a> </div>
	   ...
	   ?></strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Administrador</span> </span> </a>
              ...
              <nav class="nav-primary hidden-xs">
                ...
                <ul class="nav nav-main" data-ride="collapse">
                  <li class="active"> <a href="#" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Inicio</span> </a> 
				  <ul class="nav dk">
                      <li class="active" > <a href="dashboard.php" class="auto"><i class="i i-dot"></i> <span>Panel administrador</span> </a> </li>
                      
                    </ul>
				  </li>
                  
                  <li > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="i i-lab icon"> </i> <span class="font-bold">Configuracion Sitio Web</span> </a>
                    <ul class="nav dk">
                      <li > <a href="gensettings.php" class="auto"> <i class="i i-dot"></i> <span>Configuracion General</span> </a> </li>
					  <li> <a href="emailsettings.php" class="auto"> <i class="i i-dot"></i> <span>Correo Electronico</span> </a> </li>
                      
                      
                      
                      <li > <a href="pacsettings.php" class="auto"> <i class="i i-dot"></i> <span>Configuracion Paquetes</span> </a> </li>
					  <li > <a href="backups/backup.php" class="auto"> <i class="i i-dot"></i> <span>Generar Copia de seguridad</span> </a> </li>
				  ...
				  <li > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="fa fa-info-circle"> </i> <span class="font-bold">Estadisticas</span> </a>
                    <ul class="nav dk">
                      <li > <a href="users.php" class="auto"><i class="i i-dot"></i> <span>Usuarios</span> </a> </li>
                      <li > <a href="payments.php" class="auto"><i class="i i-dot"></i> <span>Pagos realizados </span> </a> </li>
					  <li > <a href="paymentscod.php" class="auto"><i class="i i-dot"></i> <span>C.O.D Ordenes </span> </a> </li>
					  <li > <a href="payrequest.php" class="auto"><i class="i i-dot"></i> <span>Peticiones de pago de usuarios </span> </a> </li>
					  <li > <a href="renewpaymentscod.php" class="auto"><i class="i i-dot"></i> <span>Peticiones de renovacion de cuenta </span> </a> </li>
                    </ul>
                  </li>
...
?>
                  <footer class="panel-footer bg-info text-center">
                    <div class="row pull-out">
                      <div class="col-xs-6">
                        <div class="padder-v"> <span class="m-b-xs h3 block text-white"><?php print $totalusers ?></span> <small class="text-muted">Total de usuarios</small> </div>
                      </div>
...
if($toid==1){
 ...
 ?>
                        <div class="padder-v"> <span class="m-b-xs h3 block text-white"><?php print $totalpayments ?></span> <small class="text-muted">Total de pagos hasta el momento</small> </div>
                      </div>
